   ...
   /* const [ vacApi, setVacApi ] = useState([]);
    ...
    return(
        <Container className="justify-content-center">
            <h1 className="text-center">Listado de Vacunas <FontAwesomeIcon icon={faPlus} size="lg" color="#2D61A4"
                    onClick={() => window.location.replace("/admin/addVac")}
                />
            </h1>
            ...
            <ListGroup>
                ...
                <Row>
                    <Col md={2} className="align-self-center">
                        <p style={{"color": "#2D61A4", "font-size": 22}}><b>Numero Documento </b> <br/></p>
                    </Col>
                    <Col md={2} className="align-self-center">
                    ...
                    <Col md={2} className="align-self-center justify-content-around">
