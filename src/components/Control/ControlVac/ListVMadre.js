             ...
             <Col sm={12} >
               ...
               <Row className="mt-2 mb-2 justify-content-center">
                   <Col md={3} className="align-self-center">
                       <p style={{"color": "#2D61A4", "font-size": 20}}><b>Fecha Aplicaciòn</b> <br/>{dateFormat(item.fechaAplicacion)}</p>
                   </Col>
                   <Col md={2} className="align-self-center">
                       <p style={{"color": "#2D61A4", "font-size": 20}}><b>Numero Documento</b> <br/>{item.idUsuario}</p>
                   </Col>
                   <Col md={2} className="align-self-center">
                       <p style={{"color": "#2D61A4", "font-size": 20}}><b>Nombre Vacuna </b> <br/>{item.nombreVacuna}</p>
                   </Col>
                   <Col md={2} className="row justify-content-center align-self-center">
                       <p style={{"color": "#2D61A4", "font-size": 20}}><b>Edad Gestacional </b> <br/>{item.edadGestacional}</p>
                   </Col>
