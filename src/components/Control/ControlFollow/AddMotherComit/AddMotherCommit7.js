...
export default function AddMotherCommit7(props) {
  const { edit, showCommit7, setShowCommit7, setDataCommit7, dataCommit7, setSaveData7} = props;
        ...
        <Container >
            <Row>
                ...
                initialValues={{ 
                  ...
                  name: "Reconoce las señales de peligro durante el embarazo", 
                  description: "",  
                  dateEnd: ""
                }}
                validate={(valores) => {
