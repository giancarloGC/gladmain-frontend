...
export default function DetailsMothertInc(props){
                ...
                {props => {
                    ...
                    <Form.Group as={Row} className="mt-2 " style={{ "marginLeft":"6px"}}>
                        <Form.Label column sm="3"><h1 style={{"fontSize": "22px", "color":"#0084d2" }} className="mt-1">No. Seguimiento </h1></Form.Label>
                          <Col sm="2">
                            ...
                            <Form.Control
                            type="number" disabled className="text-center" placeholder="01" size="lg" id="idSeguimiento" name="idSeguimiento" 
                        ...
                        <Form.Label column sm="3"><h1 style={{"fontSize": "22px", "color":"#0084d2" }} className="mt-1">Semana de Gestación</h1></Form.Label>
                          <Col sm="2">
                          <InputGroup hasValidation>
                               <Form.Control disabled type="text" placeholder="# de semanas" size="lg" id="cantidadSemanas" name="cantidadSemanas" 
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"6px"}}>
                       ...
                       <h5 style={{"fontSize": "16px"}} className="mt-1">Cuenta con afiliación al SGSSS</h5></Form.Label>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled checked={showCommit || !saveData ? false : true } onChange={(e) => setShowCommit(!e.target.checked)}></input>
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled checked={showCommit2 || !saveData2 ? false : true } onChange={(e) => setShowCommit2(!e.target.checked)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"6px"}} className="mt-2">
                       ...
                       <h5 style={{"fontSize": "16px"}}>Conoce la red de salud o a quien acudir en caso de urgencia</h5></Form.Label>
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled checked={showCommit3 || !saveData3 ? false : true } onChange={(e) => setSaveData3(e.target.checked)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                        ...
                        <InputGroup hasValidation className="mt-1">
                          ...
                          <input type="checkbox" disabled checked={showCommit4 || !saveData4 ? false : true } onChange={(e) => setShowCommit4(!e.target.checked)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Group as={Row}  style={{ "marginLeft":"6px"}} className="mt-2">
                       ...
                       <h5 style={{"fontSize": "16px"}}>Cuenta con suministro de micronutrientes Hierro, Ácido fólico y calcio y los consume</h5></Form.Label>
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled checked={showCommit5 || !saveData5 ? false : true } onChange={(e) => setShowCommit5(!e.target.checked)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled checked={showCommit6 || !saveData6 ? false : true } onChange={(e) => setShowCommit6(!e.target.checked)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Group as={Row}  style={{ "marginLeft":"6px"}}>
                        ...
                        <InputGroup hasValidation className="mt-1">
                          ...
                          <input type="checkbox" disabled checked={showCommit7 || !saveData7 ? false : true } onChange={(e) => setSaveData7(e.target.checked)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Group as={Row}  style={{ "marginLeft":"6px"}} className="mt-2">
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled checked={showCommit8 || !saveData8 ? false : true } onChange={(e) => setShowCommit8(!e.target.checked)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"6px"}}>
                       ...
                       <h5 style={{"fontSize": "16px", "fontWeight":"bold" }}>Presenta una patología asociada identificada por el SGSSS</h5></Form.Label>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled name="showPatologia" checked={showCommit9 || !saveData9 ? false : true } onChange={(e) => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    {showPatologia && (
                      ...
                      <Col sm="9" class="mid" style={{marginLeft:"7px"}}>
                          <InputGroup hasValidation>
                                <Form.Control type="text" disabled placeholder="Nombre Patología" size="xs" id="nombrePatologia" name="nombrePatologia" 
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled name="showMedicamentos" checked={showCommit10 || !saveData10 ? false : true } onChange={(e) => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    {showMedicamentos && (
                      ...
                      <Col md="9" class="mid" style={{marginLeft:"7px"}}>
                          <InputGroup hasValidation>
                                <Form.Control type="text" disabled placeholder="Nombre Medicamento Formulado" size="xs" id="nombreMedFormululada" name="nombreMedFormululada" 
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"6px"}}  className="mt-3">
                     ...
                     <Col md="9" class="mid" style={{marginLeft:"7px"}}>
                        <InputGroup hasValidation>
                               <Form.Control type="text" disabled placeholder="Nombre EAPB" size="xs" id="eapb" name="eapb" 
                        ...
                        <InputGroup hasValidation>
                               <Form.Control type="text" disabled placeholder="Nombre IPS" size="xs" id="ips" name="ips" 
                    ...
                    <Form.Group as={Row}  style={{ "marginLeft":"6px"}} className="mt-3">
                       ...
                       <h5 style={{"fontSize": "16px", "fontWeight":"bold" }}>El usuario fue remitido a SGSSS </h5></Form.Label>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled name="showRemitido" checked={showCommit11 || !saveData11 ? false : true } onChange={(e) => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    {showRemitido && (
                      ...
                      <Col sm="9" style={{marginLeft:"7px"}} className="mt-2">                        
                          <InputGroup hasValidation>
                                <Form.Control type="text" disabled placeholder="Escriba la causa" size="xs" id="causa" name="causa" 
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"6px"}} className="mt-1">
                       ...
                       <h5 style={{"fontSize": "16px", "fontWeight":"bold"}} className="mt-1">Vómito continuo</h5></Form.Label>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled name="vomitoControlado" checked={checkeds.vomitoControlado === "SI" ? true : false} onChange={e => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>  
                        </InputGroup>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled name="dolorCabeza" checked={checkeds.dolorCabeza === "SI" ? true : false} onChange={e => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>  
                        </InputGroup>
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"6px"}} className="mt-2">
                       ...
                       <h5 style={{"fontSize": "16px", "fontWeight":"bold"}} className="mt-2">Fiebre</h5></Form.Label>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled name="fiebre" checked={checkeds.fiebre === "SI" ? true : false}  onChange={e => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>  
                        </InputGroup>
                       ...
                       <h5 style={{"fontSize": "16px"}} className="mt-1">Dolor en boca del estómagor</h5></Form.Label>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled name="dolorBocaEstomago" checked={checkeds.dolorBocaEstomago === "SI" ? true : false}   onChange={e => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>  
                        </InputGroup>
                       ...
                       <h5 style={{"fontSize": "16px"}} className="mt-1">Ardor al orinar</h5></Form.Label>
                        ...
                        <InputGroup hasValidation>
                         <label class="rocker rocker-small" size="xs" name="ardorOrinar" id="ardorOrinar">
                          <input type="checkbox" disabled name="ardorOrinar" checked={checkeds.ardorOrinar === "SI" ? true : false}  onChange={e => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>  
                        </InputGroup>
                        ...
                        <InputGroup hasValidation>
                         <label class="rocker rocker-small" size="xs" name="sangrado" id="sangrado">
                          <input type="checkbox" disabled name="sangrado" checked={checkeds.sangrado === "SI" ? true : false} onChange={e => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label> 
                        </InputGroup>
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"6px"}} className="mt-2">
                       ...
                       <h5 style={{"fontSize": "16px", "fontWeight":"bold" }} className="mt-2">Cara, manos o pies hinchados</h5></Form.Label>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled name="hinchamiento" checked={checkeds.hinchamiento === "SI" ? true : false} onChange={e => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>  
                        </InputGroup>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled name="movimientoFetal" checked={checkeds.movimientoFetal === "SI" ? true : false}  onChange={e => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>  
                        </InputGroup>
