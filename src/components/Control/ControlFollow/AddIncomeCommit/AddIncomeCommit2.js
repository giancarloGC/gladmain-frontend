...
export default function AddIncomeCommit(props) {
  const { showCommit2, setShowCommit2, setDataCommit2, dataCommit2, setSaveData2} = props;
    return(
      <Modal show={showCommit2 ? true : false} size="lg"  onHide={() => setShowCommit2(false)}  centered aria-labelledby="example-custom-modal-styling-title">
        ...
        <Container >
            <Row>
                ...
                initialValues={{ 
                  ...
                  name: "Cuenta con valoración y controles en salud oral", 
                  description: "",  
                  dateEnd: ""
                }}
                validate={(valores) => {
