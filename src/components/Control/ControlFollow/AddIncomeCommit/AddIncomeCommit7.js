...
export default function AddIncomeCommit(props) {
  const { showCommit7, setShowCommit7, setDataCommit7, dataCommit7, setSaveData7} = props;
    return(
      <Modal show={showCommit7 ? true : false} size="lg"  onHide={() => setShowCommit7(false)}  centered aria-labelledby="example-custom-modal-styling-title">
