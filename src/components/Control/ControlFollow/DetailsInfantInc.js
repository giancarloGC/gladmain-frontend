                ...
                {props => {
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"43px"}} className="mt-1">
                       ...
                       <h5 style={{"fontSize": "16px", "fontWeight":"bold"}} className="mt-1">Cuenta con afiliación al SGSSS</h5></Form.Label>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled checked={showCommit || !saveData ? false : true } onChange={(e) => saveData ? setShowCommit(!e.target.checked) : setSaveData(!saveData)} disabled></input>
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled checked={showCommit2 || !saveData2 ? false : true } onChange={(e) => saveData2 ? setShowCommit2(!e.target.checked) : setSaveData2(!saveData2)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"43px"}} className="mt-2 mb-1">
                       ...
                       <h5 style={{"fontSize": "16px", "fontWeight":"bold"}} className="mt-2">Conoce la red de salud o a quien acudir en caso de urgencia</h5></Form.Label>
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled checked={showCommit4 || !saveData4 ? false : true } onChange={(e) => setSaveData4(e.target.checked)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Group as={Row}  style={{ "marginLeft":"43px"}} className="mt-1">
                       ...
                       <h5 style={{"fontSize": "16px", "fontWeight":"bold" }}>En niñas y menores de un mes se realizó validación médica</h5></Form.Label>
                        ...
                        <InputGroup hasValidation >
                          ...
                          <input type="checkbox" disabled checked={showCommit5 || !saveData5 ? false : true } onChange={(e) => saveData5 ? setShowCommit5(!e.target.checked) : setSaveData5(!saveData5)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled checked={showCommit6 || !saveData6 ? false : true } onChange={(e) => saveData6 ? setShowCommit6(!e.target.checked) : setSaveData6(!saveData6)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Group as={Row}  style={{ "marginLeft":"43px"}} className="mt-2">
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled name="showSuplemento" checked={showCommit10 || !saveData10 ? false : true } onChange={(e) => setSaveData10(e.target.checked)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"43px"}} className="mt-2">
                       ...
                       <h5 style={{"fontSize": "16px", "fontWeight":"bold" }} className="mt-2">Presenta una patología asociada identificada por el SGSSS</h5></Form.Label>
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled name="showPatologia" checked={showCommit7 || !saveData7 ? false : true } onChange={(e) => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Col sm="9" class="mid">
                        <InputGroup hasValidation>
                               <Form.Control disabled type="text" placeholder="Nombre Patología" size="xs" id="nombrePatologia" name="nombrePatologia" 
                        ...
                        <InputGroup hasValidation className="mt-2">
                          ...
                          <input type="checkbox" disabled name="showMedicamentos" checked={showCommit8 || !saveData8 ? false : true } onChange={(e) => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
                    ...
                    <Col md="9" class="mid" >
                        <InputGroup hasValidation>
                               <Form.Control disabled type="text" placeholder="Nombre Medicamento Formulado" size="xs" id="nombreMedFormululada" name="nombreMedFormululada" 
                    ...
                    <Form.Group as={Row} style={{ "marginLeft":"43px"}}  className="mt-3">
                     ...
                     <Col md="4" class="mid" >
                        <InputGroup hasValidation>
                               <Form.Control disabled type="text" placeholder="Nombre EAPB" size="xs" id="eapb" name="eapb" 
                    ...
                    <Form.Group as={Row}  style={{ "marginLeft":"43px"}} className="mt-3">
                       ...
                       <h5 style={{"fontSize": "16px", "fontWeight":"bold" }}>El usuario fue remitido a SGSSS </h5></Form.Label>
                        ...
                        <InputGroup hasValidation>
                          ...
                          <input type="checkbox" disabled name="showRemitido" checked={showCommit9 || !saveData9 ? false : true } onChange={(e) => onChangeChecked(e)}></input>
                          <span class="switch-left">Si</span>
                          <span class="switch-right">No</span>
                          </label>
                            <Form.Control.Feedback type="invalid">
