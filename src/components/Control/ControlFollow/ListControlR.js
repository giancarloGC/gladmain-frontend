...
export default function ListControlR(props){
    const {listRemis, user, setListRemis, allRemisionsSaved, idSeg, documento} = props;
                ...
                {listRemis.map((item, index) => (
                        ...
                        <Row >
                            ...
                            <Col sm={3} className="align-self-right">
                                ...
                                {validatePrivilegio("CONSULTAR_REMICION").length > 0 && (
                                ...
                                {validatePrivilegio("ACTUALIZAR_REMICION").length > 0 && ("CONSULTAR_REMICION").length > 0 && (
                                ...
                                {validatePrivilegio("ELIMINAR_REMICION").length > 0 && (
