...
const data = {
    ...
    return[
    {
      ...
      data: sexo === "MASCULINO" ?  [ 9.7, 10, 10.3, 10.6, 10.9, 11.1, 11.4, 11.7, 11.9, 12.1, 
                                    ...
                                    :[ 9,9.38,9.7,10,10.3,10.55,10.8,11.1,11.4,11.6,11.82,12.1,
    ...
    },
    {
      ...
      data: sexo === "MASCULINO" ?  [ 10.9, 11.2, 11.5, 11.8, 12.1, 12.4, 12.7, 13, 13.3, 13.6, 
                                 ...
                                 :  [ 10.2, 10.5, 10.88, 11.2, 11.55, 11.9, 12.2, 12.5, 12.85, 
                                      13.15, 13.46, 13.7, 14, 14.34, 14.63, 14.95, 15.2, 15.5, 15.7],
      fill: false,
    ...
    },
    {
      ...
      data: sexo === "MASCULINO" ?  [ 12.3, 12.6, 12.9, 13.2, 13.6, 13.9, 14.3, 14.7, 15.1, 15.4, 
                                    ...
                                    :[ 11.5,11.95,12.35,12.7,13.08,13.5,13.88,14.2,14.57,15,15.35,
                                      15.7,16.05,16.47,16.8,17.2,17.53,17.9,18.2 ],
      fill: false,
