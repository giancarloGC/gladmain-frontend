    ...
    function lineas(){
      return [{
        ...
        data: sexo === "MASCULINO" ? [ 2.4, 3.4, 4.4, 5, 5.6, 6, 6.4, 6.7, 7, 7.2, 7.4, 7.6, 7.8, 8, 
                                   ...
                                   : [ 2.35, 3.2, 3.95, 4.55, 5, 5.45, 5.75, 6, 6.25, 6.49, 6.72, 6.92, 
                                       7.05, 7.23, 7.45, 7.52, 7.75, 7.95, 8.1,  8.24, 8.42, 8.51, 8.75, 
                                       8.9, 9.05,],
        fill: false,
      ...
      
      {
        ...
        data:  sexo === "MASCULINO" ? [ 2.8, 3.9, 4.9, 5.6, 6.2, 6.7, 7.1, 7.5, 7.8, 8.1, 8.3, 8.5, 8.7, 
                                    ...
                                    : [ 2.7, 3.65, 4.5, 5.2, 5.73, 6.1, 6.49, 6.8, 7.02, 7.3, 7.55, 7.75, 
                                        7.95, 8.2, 8.35, 8.5, 8.7, 8.85, 9.05, 9.28, 9.45, 9.65, 9.8, 9.95, 
                                        10.15],
        fill: false,
...

      {
        ...
        data: sexo === "MASCULINO" ? [ 3.4, 4.5, 5.5, 6.5, 7.2, 7.7, 8.1, 8.4, 8.7, 9, 9.3, 9.6, 9.8, 10, 10.2, 
                                   ...
                                   : [ 3.15, 4.2, 5.15, 5.85, 6.48, 6.9, 7.3, 7.7, 7.95, 8.25, 8.49, 8.73, 8.98, 
                                      9.2, 9.4, 9.6, 9.8, 10, 10.25, 10.45, 10.7, 10.8, 11.05, 11.3, 11.48],
        fill: false,
      ...
      },
      {
        ...
        data: sexo === "MASCULINO" ? [ 3.8, 5, 6.3, 7.2, 7.9, 8.4, 8.8, 9.2, 9.6, 9.9, 10.2, 10.5, 10.8, 11.1, 
                                   ...
                                   : [ 3.6, 4.8, 5.85, 6.65, 7.3, 7.78, 8.25, 8.65, 9, 9.35, 9.6, 9.85, 10.15, 10.4, 
                                       10.65, 10.85, 11.15, 11.4, 11.6, 11.8, 12.1, 12.3, 12.55, 12.78, 13],
        fill: false,
      ...
      },
      {
        ...
        data: sexo === "MASCULINO" ? [ 4.4, 5.6, 7, 8, 8.8, 9.4, 9.9, 10.3, 10.7, 11.1, 11.4, 11.7, 12, 12.3, 12.6, 
                                   ...
                                   : [ 4.2, 5.5, 6.65, 7.5, 8.25, 8.85, 9.4, 9.8, 10.2, 10.55, 10.95, 11.2, 11.5, 
                                       11.78, 12.1, 12.4, 12.7, 12.95, 13.2, 13.5, 13.78, 14, 14.3, 14.6, 14.85],
        fill: false,
        borderColor: sexo !== "FEMENINO" ? '#363D44' : '#363D44',
        tension: 0.1,
      }
