    ...
    function lineas(){
      return [{
        ...
        data: sexo === "MASCULINO" ?  [ 13,13,13,13,13.05,13.1,13.15,13.2,13.24,13.27,13.3,13.35,13.4,13.43,13.46,13.48,13.51,13.55,
                                      ...
                                      [ 12.7, 12.7, 12.7, 12.7, 12.7, 12.7, 12.7, 12.73, 12.75, 12.78, 12.8, 12.9, 12.95, 13, 13.05, 
                                        13.1, 13.2, 13.25, 13.35, 13.45, 13.5, 13.6, 13.7, 13.8, 13.9, 14, 14.15, 14.25, 14.45, 14.55, 
                                        14.6, 14.8, 14.95, 15.05, 15.2, 15.4, 15.45, 15.55, 15.65, 15.75, 15.85, 16,16.05, 16.1, 16.15, 
                                        16.2, 16.25, 16.3, 16.35, 16.4, 16.43, 16.47, 16.49, 16.5, 16.5, 16.5, 16.5],
        fill: false,
      ...
      },
      {
        ...
        data: sexo === "MASCULINO" ?  [ 14.1,14.1,14.1,14.1,14.1,14.12,14.15,14.2,14.25,14.3,14.35,14.4,14.45,14.5,14.55,14.62,14.7,14.75,
                                        ...
                                        19.4,19.5,19.6 ] :
                                      [ 13.98, 13.98, 13.98, 13.98, 13.98, 13.98, 13.98, 13.99, 14, 14.01, 14.03, 14.05, 14.08, 14.15, 14.2, 
                                        14.3, 14.4, 14.5, 14.6, 14.7, 14.8, 14.95, 15.05, 15.2, 15.35, 15.48, 15.6, 15.75, 15.95, 16.1, 
                                        16.27, 16.48, 16.55, 16.8, 16.9, 17.05, 17.2, 17.4, 17.55, 17.65, 17.8, 17.9, 17.98, 18.05, 18.15, 
                                        18.25, 18.3, 18.4, 18.45, 18.5, 18.53,18.55, 18.58, 18.6, 18.65, 18.65, 18.7],
        fill: false,
      ...
      },
      {
        ...
        data: sexo === "MASCULINO" ?  [ 15.3,15.3,15.3,15.3,15.35,15.4,15.46,15.5,15.55,15.58,15.62,15.67,15.73,15.8,15.9,15.98,16.05,16.13,
                                        ...
                                        22.1,22.2 ] :
                                      [ 15.15, 15.2, 15.25, 15.3, 15.3, 15.3, 15.3, 15.4, 15.45, 15.5, 15.55, 15.6, 15.7, 15.8, 15.9, 16, 16.1, 
                                        16.2, 16.35, 16.45, 16.55,16.75, 16.95, 17.05, 17.25, 17.45, 17.55, 17.8, 18, 18.2, 18.43, 18.55, 18.76, 
                                        19,19.15,19.4, 19.53, 19.75, 19.95, 20.1, 20.2, 20.4, 20.48, 20.51, 20.65, 20.78, 20.8, 21, 21.05, 21.1, 
                                        21.2, 21.25, 21.28, 21.3, 21.35, 21.4, 21.45],
        fill: false,
      ...
      },
      {
        ...
        data: sexo === "MASCULINO" ?  [ 16.6,16.68,16.73,16.79,16.85,16.95,17.05,17.15,17.25,17.35,17.45,17.55,17.63,17.72,17.8,17.9,17.98,
                                        ...
                                        25.2,25.3,25.4 ] :
                                      [ 16.9, 16.93, 16.97, 17, 17.05, 17.05, 17.1, 17.2, 17.3, 17.4, 17.5, 17.6, 17.7, 17.8, 18.05, 18.15, 
                                        18.4, 18.52, 18.7, 18.85, 19.05, 19.25, 19.48, 19.65, 19.9, 20.1, 20.4, 20.6, 20.83, 21, 21.25, 21.55, 
                                        21.9, 22.1, 22.4, 22.5, 22.75, 22.98, 23.2, 23.4, 23.5, 23.7, 23.8, 23.95, 24.05, 24.15, 24.35, 24.4, 
      ...
      },
      {
        ...
        data: sexo === "MASCULINO" ?  [ 18.3,18.42,18.5,18.59,18.7,18.78,18.89,18.97,19.1,19.2,19.36,19.5,19.7,19.9,20.1,20.3,20.5,20.7,20.9,
                                        ...
                                        29.8 ] :
                                      [ 18.9, 18.95, 19, 19.05, 19.15, 19.35, 19.5, 19.6, 19.8, 19.98, 20.15, 20.45, 20.55, 20.8, 21.05, 
                                        21.35, 21.5, 21.75, 22, 22.3, 22.55, 22.8, 23.1, 23.45, 23.7, 24, 24.35, 24.6, 24.98, 25.4, 25.6, 
                                        25.9, 26.2, 26.48, 26.75, 27, 27.3, 27.55, 27.8, 28.05, 28.2, 28.45, 28.55, 28.75, 28.9, 28.95,29.05, 
                                        29.15, 29.25, 29.3, 29.4, 29.45, 29.5, 29.55, 29.6, 29.65, 29.7],
        fill: false,
        borderColor: sexo !== "FEMENINO" ? '#E51A1A' : '#E51A1A',
        tension: 0.1,
      }
